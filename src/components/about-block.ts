      ...
      <div class="container">
        <div class="content">
          <div>
            ...
            <p>{$ aboutBlock.callToAction.featuredSpeakers.description $}</p>
            <a
              href="{$ aboutBlock.callToAction.featuredSpeakers.link $}"
              ga-on="click"
              ga-event-category="video"
              ga-event-action="watch"
              ga-event-label="about block - {$ aboutBlock.callToAction.featuredSpeakers.label $}"
            >
              <paper-button class="animated icon-right">
                <span class="cta-label">{$ aboutBlock.callToAction.featuredSpeakers.label $}</span>
                <iron-icon icon="hoverboard:arrow-right-circle"></iron-icon>
              </paper-button>
          </div>
